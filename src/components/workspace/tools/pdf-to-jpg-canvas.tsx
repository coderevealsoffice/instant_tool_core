...
export function PdfToJpgCanvas() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      console.error(e)
      toast.error("Failed to convert PDF to JPG. Please ensure it's a valid PDF.")
    } finally {
  ...
  return (
    <ToolSplitView
      title="PDF to JPG"
      description="Extracts every page of your PDF into high-quality JPG images and downloads them as a ZIP file."
