...
import { Eye, EyeOff, Zap, ShieldCheck, Sparkles, Mail, Lock, Loader2 } from "lucide-react"

type LoginMode = "credentials" | "magic"
    ...
    <div className="flex min-h-screen bg-white dark:bg-slate-950 font-sans transition-colors duration-300">
        ...
        <div className="relative z-10 w-full max-w-2xl px-12">
          ...
          <div className="mt-8 p-6 bg-gradient-to-br from-green-500/20 to-transparent rounded-3xl border border-white/5">
            ...
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-[#c0ffa5]/20 flex items-center justify-center text-[#c0ffa5] font-bold text-xs shrink-0">JD</div>
              <div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-8 lg:px-20 py-12 relative">
        ...
        <div className="w-full max-w-[400px] relative z-10">
          ...
          {/* Mode Toggle */}
          <div className="flex bg-slate-100 dark:bg-slate-800/60 rounded-2xl p-1 mb-6 gap-1">
            <button
              type="button"
          ...
          {/* Error */}
          {error && (
            <div className="mb-4 p-3 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-xl text-sm text-red-600 dark:text-red-400 font-medium">
              {error}
            </div>
          )}
          ...
          {magicSent ? (
            <div className="text-center py-8">
              ...
              <h3 className="font-black text-slate-900 dark:text-white text-lg mb-2">Check your inbox!</h3>
              ...
              <button
                ...
                className="mt-4 text-xs font-bold text-slate-400 hover:text-slate-600 dark:hover:text-slate-300"
              >
            ...
            <form onSubmit={handleMagicLink} className="space-y-4">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-11 h-12 rounded-2xl border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 placeholder:text-slate-400 text-slate-900 dark:text-white shadow-sm"
                />
              </div>
              <Button
                type="submit"
                className="w-full h-12 text-sm font-bold rounded-2xl bg-red-600 hover:bg-red-700 text-white flex items-center justify-center gap-2 shadow-lg"
                disabled={isLoading}
              >
            ...
            <form onSubmit={handleCredentialsLogin} className="space-y-4">
              ...
              <div className="flex justify-end pt-1 pb-2">
                <Link href="/auth/forgot-password" className="text-xs font-bold text-green-600 dark:text-green-500 hover:underline">
                  Forgot password?
                </Link>
              </div>
              ...
              <Button
                type="submit"
                className="w-full h-12 text-sm font-bold rounded-2xl bg-green-950 hover:bg-green-900 dark:bg-green-900 dark:hover:bg-green-800 text-white flex items-center justify-center gap-2 shadow-lg"
                disabled={isLoading}
              >
          ...
          <div className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
            New to InstantTool?{" "}
            <Link href="/auth/register" className="font-bold text-green-600 dark:text-green-500 hover:underline">
              Sign up for free
            </Link>
          </div>
        </div>
